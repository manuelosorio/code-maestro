...
@Component({
  ...
  standalone: true,
  imports: [NavComponent, NgOptimizedImage, JoinButtonComponent, CountdownComponent, LessonsComponent],
  template: `
      <app-nav></app-nav>
      ...
      <main class="container">
          <header class="grid">
              ...
              <div class="col-1"></div>
              <div class="col-6">
                  <img ngSrc="https://placehold.co/585x317" alt="placeholder" width="585" height="317" />
              </div>
          </header>
          <section>
          ...
          <section class="grid">
              <div class="col-4">
                  <img ngSrc="https://github.com/manuelosorio.png" alt="placeholder" width="290" height="290" />
              </div>

              <div class="col-7">
                  <h2>Meet the Instructor</h2>
                  <h3>Manuel Osorio <span>(Full-stack Developer</span></h3>
                  <p>As a Full-Stack JavaScript Developer with a background in Interaction Design, I bring a unique blend of front-end and back-end expertise to my teaching. My experience ranges from UI design to work with back-end technologies. I've also worked as a Graphic Design Laboratory Aide, where I guided students in design principles and technical solutions. My professional journey includes extensive use of version control tools like Git, equipping me with practical insights and knowledge essential for delivering a comprehensive and engaging learning experience.</p>
              </div>
          </section>
          <section>
              <h2>Overview</h2>
